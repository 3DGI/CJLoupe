...
Default navigation and selection:

- `Shift + Click`: select geometry
...
- `Ctrl/Cmd + Click`: select vertex
- `J / K`: step through vertices in the active ring
- `R`: cycle polygon rings
- `X`: toggle xray edit edges
- `U`: reset the selected feature geometry
