...
- Add a ruler tool for measuring between surface clicks, with vertex snapping in edit mode
...
- Add coloring mode by normal direction
- Change semantic coloring button into a appearance mode selector
